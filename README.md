...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
   React is a js library that helps build user interface, it helps update the website to interact with the with the user without needing to refresh.

2. Describe component state.
   the component state refers to the current "state" of a variable,

3. Describe props.

prob is data you pass along to a function in order to be invoked

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

is anything that affects something outside of the scope of the function. we can sync effects by using a dependency array so that it only run when certain state or prop is altered.
